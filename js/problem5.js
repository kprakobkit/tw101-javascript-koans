...
function correctAd(ad) {
  ad.forEach(function(words, index) {
    changeElementText("#adText" + index, words.join(" "));
  });

  ad[1] = ad[1].reverse();

  var words = flattenArray(ad);

  changeElementText("#correctedText", words.join(" "));
  changeElementText("#wordCount", words.length);
}
